...
import { getRegionDetail, selectRegionDetail } from "@/redux/features/region/reducer"
...
const RegionDetail = () => {
    ...
    const item = useAppSelector(selectRegionDetail)
    ...
    const fetchItem = async () => {
        await dispatch(getRegionDetail({ id: id as unknown as number }))
    }
    ...
    return (
        <div>
            <PageHeading title={t("region.view")} currentPathname={pathname} />
