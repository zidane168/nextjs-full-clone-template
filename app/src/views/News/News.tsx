...
import { getNews, selectIsLoadNewsList, selectNews } from "@/redux/features/news/reducer"
...
const News = ({ params: { locale } }: { params: ILayoutParams }) => {
    ...
    const isLoadedList = useAppSelector(selectIsLoadNewsList)
    const pathname = usePathname()

    const listItems = useAppSelector(selectNews)
