...
import {
    getDistricts,
    selectDistricts,
    selectIsLoadDistrictList
} from "@/redux/features/district/reducer"
...
const Districts = ({ params: { locale } }: { params: ILayoutParams }) => {
    ...
    const isLoadedList = useAppSelector(selectIsLoadDistrictList)
    const pathname = usePathname()

    const listItems = useAppSelector(selectDistricts)
    ...
    return (
        <div>
            <PageHeading title={t("district.district")} currentPathname={pathname} />
